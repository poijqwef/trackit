...
parser.set_defaults(
       ...
       #serialize= 2,
       #logfile="/global/project/projectdirs/nervana/yunjie/climate_neon1.0run/conv/RESULTS/hurricane_classify_test."+c_time+".log",
       logfile="./TEST_RESULTS/hurricane_classify_test."+c_time+".log",
       #output_file="/global/project/projectdirs/nervana/yunjie/climate_neon1.0run/conv/RESULTS/hurricane_classify_S."+c_time+".h5",
       #model_file="/global/project/projectdirs/nervana/yunjie/climate_neon1.0run/conv/RESULTS/hurricane_classify_train.pkl",
       model_file="./TEST_RESULTS/hurricane_classify_train.pkl",
) 
...
(X_train, Y_train), (X_valid, Y_valid), (X_test,Y_test) = \
        data_load.happy_loader(args.data_dir,args.file_name,args.data_dict,
...
if args.model_file:
    print 'Reading model_file: '+args.model_file
...
def vis_feature(layers):
    ...
    first_convlayer_feature=first_convlayer_feature.reshape(16,28,28,100)
    second_convlayer_feature=second_convlayer_feature.reshape(32,10,10,100)
